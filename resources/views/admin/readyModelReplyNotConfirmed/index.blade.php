    ...
    <div class="content-page  @lang('sidebar.right_class')">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">القطاعات الرئيسية والفرعية
                        </li>
                    </ol>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <div class="col-sm-4">
                            <a href="{{ url('/admin/ready-model-fields/add') }}" class="btn btn-default btn-md waves-effect waves-light m-b-30"><i class="md md-add"></i>@lang('dashboard.add_main_sector') </a>
                        </div>
