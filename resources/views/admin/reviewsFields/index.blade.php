            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="#custom-modal" class="btn btn-default btn-md waves-effect waves-light m-b-30" data-animation="fadein" data-plugin="custommodal" data-overlayspeed="200" data-overlaycolor="#36404a"><i class="md md-add"></i>@lang('fields.add_new_field1') </a>
                            </div>
                        </div>
                        <table id="datatable" class="table table-bordered">
                            ...
                            <tbody>
                            @foreach ($reviewsFields as $reviewsField)
                                <tr>
                                    <td>{{ $reviewsField->arabic_name }}</td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#updateFieldRegistred").click(function(e) {
            ...
            var type = "";
            var id = $("#idField").val();
            var path = '/admin/reviews-fields/'+id;
