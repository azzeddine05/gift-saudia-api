                ...
                <div class="col-12">
                    <div class="card-box table-responsive">
                        ...
                        <table id="datatable" class="table table-bordered">
                            ...
                            <tbody>
                            @foreach ($reviewsFields as $reviewsFields)
                                <tr>
                                    <td>{{ $reviewsFields->arabic_name }}</td>
                                    <td>{{ $reviewsFields->english_name }}</td>
                                    <td>{{ $reviewsFields->type }}</td>
                                    <td>
                                        <button data-id="{{ $reviewsFields->id }}" href="{{ url('/api/admin/registration-fields/'.$reviewsFields->id) }}" class="btn btn-primary btn-rounded waves-effect waves-light editField">تعديل</button>
                                        <a href="{{ url('api/admin/registration-fields/'.$reviewsFields->id) }}" class="btn btn-danger btn-rounded waves-effect waves-light btnDelete" data-toggle="modal" data-url="" data-id="" data-target="#custom-width-modal">حدف</a>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#addField").click(function(e) {
            ...
            axios.post('/admin/reviews-fields/add', data)
                .then(response => {
