...
<script type="text/javascript" src="{{asset('back')}}/assets/pages/autocomplete.js"></script>
...
<script src="{{asset('back')}}/plugins/timepicker/bootstrap-timepicker.js"></script>
<script src="{{asset('back')}}/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
<script src="{{asset('back')}}/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
<script src="{{asset('back')}}/plugins/clockpicker/js/bootstrap-clockpicker.min.js"></script>
<script src="{{asset('back')}}/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>

<script src="{{asset('back')}}/assets/pages/jquery.form-pickers.init.js"></script>
