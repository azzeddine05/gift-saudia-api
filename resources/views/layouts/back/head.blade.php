<head>
    ...
    <link href="{{asset('back')}}/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">
    <link href="{{asset('back')}}/plugins/clockpicker/css/bootstrap-clockpicker.min.css" rel="stylesheet">
    <link href="{{asset('back')}}/plugins/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">

    <link href="{{asset('back')}}/plugins/custombox/css/custombox.css" rel="stylesheet">
